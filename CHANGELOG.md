...
## [0.95.0](https://github.com/reanahub/reana/compare/0.9.4...0.95.0) (2026-06-26)
...
* **helm:** bump Redis cache image from 5.0.5 to 8.6.3 ([#966](https://github.com/reanahub/reana/issues/966)) ([f9416fb](https://github.com/reanahub/reana/commit/f9416fb3534a76ed31608a473387df7c35192277))
...
* **helm:** add configurable UI security headers ([#945](https://github.com/reanahub/reana/issues/945)) ([9fe2c49](https://github.com/reanahub/reana/commit/9fe2c49b1e6e6d7fc43c5ac4f1d4eaf1ee752263))
...
* **helm:** add controller uWSGI ConfigMaps ([#953](https://github.com/reanahub/reana/issues/953)) ([ecdaffc](https://github.com/reanahub/reana/commit/ecdaffc4e80d437b2e8099d093ffed2d24625a93))
...
* **helm:** add quota period Helm support ([#931](https://github.com/reanahub/reana/issues/931)) ([37af266](https://github.com/reanahub/reana/commit/37af266f60ad2fd11cdc7a7add4417313b9e1f57))
* **helm:** add token management secret configuration ([#950](https://github.com/reanahub/reana/issues/950)) ([fe71ab3](https://github.com/reanahub/reana/commit/fe71ab361986f3e215e1bf0509886e4e0ce8f8c9))
* **helm:** add value to customise vetted container images ([#902](https://github.com/reanahub/reana/issues/902)) ([207b10f](https://github.com/reanahub/reana/commit/207b10f9aba3064a8ca546bf36e119f2e9fc8ef6))
...
* **helm:** allow customising minimum Kubernetes job user ID ([#956](https://github.com/reanahub/reana/issues/956)) ([1cd83ab](https://github.com/reanahub/reana/commit/1cd83abcbbc76cecca8b33e6bdb53a8c3a7985b1))
...
* **helm:** pass vetted image policy to job controllers ([#970](https://github.com/reanahub/reana/issues/970)) ([c31f587](https://github.com/reanahub/reana/commit/c31f5870c4a0928cd5e19772b1119cdcabe73fe2))
...
* **helm:** use a named ACL user for the Redis cache ([#966](https://github.com/reanahub/reana/issues/966)) ([e236d66](https://github.com/reanahub/reana/commit/e236d6617500714e541c925d9f903983fad65167))
* **reana-dev:** add --issue option to git-checkout-pr ([#948](https://github.com/reanahub/reana/issues/948)) ([7d82ed6](https://github.com/reanahub/reana/commit/7d82ed608a12e6b463935de1270cd7242c7ecd4c))
...
* **reana-dev:** add create-branch option to git-upgrade command ([#958](https://github.com/reanahub/reana/issues/958)) ([d08cb5c](https://github.com/reanahub/reana/commit/d08cb5cb5e6fc4c04bc71e14375df7cdfdc61d19))
* **reana-dev:** add git-iteration-rollover command ([#960](https://github.com/reanahub/reana/issues/960)) ([bc7654e](https://github.com/reanahub/reana/commit/bc7654e5a30248730478152c5d022af5a8f9647b))
...
* **reana-dev:** auto-create multi-arch release-docker builder ([#959](https://github.com/reanahub/reana/issues/959)) ([aa9f5e5](https://github.com/reanahub/reana/commit/aa9f5e57217f0e0443a3a0b511c3b04b9d1d2b1f))
* **reana-dev:** avoid shell interpolation in git-upgrade command ([#958](https://github.com/reanahub/reana/issues/958)) ([39b3140](https://github.com/reanahub/reana/commit/39b31401d485b433c0403fe0ceeb3ed22cc1ffec))
...
* **reana-dev:** register reana-datastore-s3fs component ([#979](https://github.com/reanahub/reana/issues/979)) ([ca70738](https://github.com/reanahub/reana/commit/ca707381272c0294d629def3b0e451e08c7bd063))
* **reana-dev:** reuse existing local branch in git-checkout-pr ([#947](https://github.com/reanahub/reana/issues/947)) ([6296b66](https://github.com/reanahub/reana/commit/6296b6628cc664e5db0d77d2e9581a66bcb76a50))
...
* **config:** use glob for egg-info in flake8 exclude ([#896](https://github.com/reanahub/reana/issues/896)) ([bee69e4](https://github.com/reanahub/reana/commit/bee69e47090e9746a8c071d95a1dfa62485a1141)), closes [#882](https://github.com/reanahub/reana/issues/882)
...
* **helm:** only mount CERN/EOSC SSO secrets when configured ([#966](https://github.com/reanahub/reana/issues/966)) ([1456eb6](https://github.com/reanahub/reana/commit/1456eb60f51eff1d75f5577f5f7359e6f0dee81d))
* **helm:** only mount GitLab OAuth secrets when configured ([#966](https://github.com/reanahub/reana/issues/966)) ([2b4658c](https://github.com/reanahub/reana/commit/2b4658c11bedc79a642c3a1f1fa547e29cd3c51b))
...
* **helm:** require explicit DB, MQ, cache and OpenSearch secrets ([#966](https://github.com/reanahub/reana/issues/966)) ([bc9303f](https://github.com/reanahub/reana/commit/bc9303f1f5bfee138b94fb9322e3441bb51ed31a))
* **helm:** require explicit REANA_SECRET_KEY ([#966](https://github.com/reanahub/reana/issues/966)) ([b2eeacc](https://github.com/reanahub/reana/commit/b2eeaccd4fbda34708752b176937a35b2ab2300b))
...
* **reana-dev:** activate environment using dot-source command ([#965](https://github.com/reanahub/reana/issues/965)) ([08739a9](https://github.com/reanahub/reana/commit/08739a90a512de9b84063ee8afaaa2317402a01d)), closes [#962](https://github.com/reanahub/reana/issues/962)
* **reana-dev:** avoid multi-manifest indices in kind load ([#961](https://github.com/reanahub/reana/issues/961)) ([8eaf55d](https://github.com/reanahub/reana/commit/8eaf55d4e7ed597762c8807eed1f5a4ad7709fc7))
...
* **reana-dev:** check local branches with `git show-ref` ([#969](https://github.com/reanahub/reana/issues/969)) ([35cba20](https://github.com/reanahub/reana/commit/35cba20c2a5814337f09f1fbac5b236095a4f406))
* **reana-dev:** drop `shell=True` from remaining hot paths ([#969](https://github.com/reanahub/reana/issues/969)) ([1758677](https://github.com/reanahub/reana/commit/1758677de9f97a0e29bb9f6ca3c127c5d1f8e88c))
* **reana-dev:** run `git-fetch` components in parallel ([#969](https://github.com/reanahub/reana/issues/969)) ([0050b04](https://github.com/reanahub/reana/commit/0050b049a8b9840e1ca47c284d80b73cacb2ccd2))
* **reana-dev:** speed up git-status on macOS ([#969](https://github.com/reanahub/reana/issues/969)) ([5824e15](https://github.com/reanahub/reana/commit/5824e155b98ea03add5350e813a07516759c9485))


### Code refactoring

* **pytest:** drop pytest-reana and use pytest directly ([#949](https://github.com/reanahub/reana/issues/949)) ([5d681f6](https://github.com/reanahub/reana/commit/5d681f6b2df7b6db530a90f259cfc9a52d5db2fe))
...
* **helm:** align README with chart secret hardening ([#966](https://github.com/reanahub/reana/issues/966)) ([2d8c86f](https://github.com/reanahub/reana/commit/2d8c86fc5c483f7c18f8fc2a11dfc95e40e91b51))
...
* **helm:** document REANA_RATELIMIT_SLOWER and SLOWEST ([#966](https://github.com/reanahub/reana/issues/966)) ([fd6609e](https://github.com/reanahub/reana/commit/fd6609e3e4a301def6bc076e6aea9468a1fe0960))
